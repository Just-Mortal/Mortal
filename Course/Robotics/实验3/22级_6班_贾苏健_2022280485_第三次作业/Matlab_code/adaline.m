...
% 实验1: 不同初始权重
[errors1, final_weight_i_1, final_weight_0_1] = adaline_train(train_images_array, train_label, 0, 0.01, 100, 0.15);
[errors2, final_weight_i_2, final_weight_0_2] = adaline_train(train_images_array, train_label, 1, 0.01, 100, 0.15);

% 实验2: 不同训练速率
[errors3, final_weight_i_3, final_weight_0_3] = adaline_train(train_images_array, train_label, 1, 0.001, 100, 0.15);
[errors4, final_weight_i_4, final_weight_0_4] = adaline_train(train_images_array, train_label, 1, 0.015, 100, 0.15);
