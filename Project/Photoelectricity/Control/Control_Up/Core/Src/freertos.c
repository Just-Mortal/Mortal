...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(Monitor, StartMonitorTask, osPriorityLow, 0, 256);
  MonitorHandle = osThreadCreate(osThread(Monitor), NULL);

  /* definition and creation of Control */
  osThreadDef(Control, StartControlTask, osPriorityNormal, 0, 1024);
  ControlHandle = osThreadCreate(osThread(Control), NULL);

  /* definition and creation of System */
  osThreadDef(System, StartSystemTask, osPriorityHigh, 0, 128);
