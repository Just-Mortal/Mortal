...
#define GIMBAL_PCH_MIDDLE_ANGLE 	6801.f	// ��������

#define GIMBAL_PCH_MEC_UP_ANGLE 	334		// 最下
#define GIMBAL_PCH_MEC_DOWN_ANGLE -310	// 最上
#define GIMBAL_PCH_IMU_UP_ANGLE 	14.0951939	// 最上
#define GIMBAL_PCH_IMU_DOWN_ANGLE -13.5023651	// 最下
