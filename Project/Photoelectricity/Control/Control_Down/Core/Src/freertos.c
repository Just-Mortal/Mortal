...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(MonitorTask, StartMonitorTask, osPriorityAboveNormal, 0, 128);
  MonitorTaskHandle = osThreadCreate(osThread(MonitorTask), NULL);

  /* definition and creation of System */
  osThreadDef(System, StartSystemTask, osPriorityBelowNormal, 0, 256);
  SystemHandle = osThreadCreate(osThread(System), NULL);

  /* definition and creation of Control */
  osThreadDef(Control, StartControlTask, osPriorityNormal, 0, 512);
